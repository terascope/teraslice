...
function newSlicer(context, opConfig, jobConfig) {
    ...
    // TODO: these validation checks should be converted to a schema once that function is available
    ...
    return function(completed) {
        //if ((completed.slice !== undefined) && (jobConfig.lifecycle === 'persistent')) partitions.push(completed.slice);
        if ((completed.slice !== undefined)) partitions.push(completed.slice);
