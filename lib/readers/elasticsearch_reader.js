    ...
    return function(msg) {
        ...
        if (canRun) {
            ...
            /* console.log('start',start.format());
             console.log('lookAheadStart',lookAheadStart.format());
             console.log('lookAheadEnd',lookAheadEnd.format());
             console.log('end',end.format());
             console.log('limit',limit.format());*/
            if (start >= limit) {
                canRun = false;
                return null;
            }
                ...
                client.count({
                    ...
                    .then(function(data) {
                        if (data.count === 0) {
                            ...
                            console.log('got data moving forward');
                            canRun = true;
