...
module.exports = function(context) {
    ...
    var logger = context.apis.foundation.makeLogger({module: 'node_master'});
    ...
    messaging.register('assets:preloaded', function(assetsMsg) {
        messaging.send('node:message:processed', assetsMsg);
    });
    ...
    if(context.sysconfig.teraslice.cluster_manager_type === 'kubernetes'){
        ...
        //used to retry a job on startup after a stop command
        if (ex.recover_execution && worker_type === 'slicer') {
