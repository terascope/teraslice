...
module.exports = function(context) {
    ...
    socket.on('cluster_service:slicer analytics', function(data){
        messageWorkers(context, data, {message: 'cluster_service:slicer analytics'}, function(worker) {
            if (data.job_id) {
    ...
    function messageHandler(msg) {
        ...
        if (msg.message === 'slicer:failed_recovery') {
            socket.emit('slicer:failed_recovery', {job_id: msg.job_id});
        }

        //error in creating the slicer
