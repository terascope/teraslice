...
module.exports = function(context) {
    ...
    socket.on('connect_error', function(ev) {
        logger.warn('Attempting to connect to cluster_master: ' + host + ' , connection error: ' + JSON.stringify(ev))
    });
    ...
    function messageHandler(processMsg) {
        ...
        if (processMsg.message === 'slicer:error') {
            socket.emit('slicer:error', processMsg);
            return;
        }
