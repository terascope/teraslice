...
module.exports = function module(context, { skipRegister } = {}) {
    let opPath = '';
    ...
    function getClient(opConfig, type) {
        ...
        if (opConfig && Object.prototype.hasOwnProperty.call(opConfig, 'connection')) {
            ...
            clientConfig.cached = opConfig.connection_cache != null ? opConfig.connection_cache : true;
        } else {
    ...
    if (!skipRegister) { // for teraslice-worker
