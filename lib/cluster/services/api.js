...
module.exports = function module(context, app, services) {
    ...
    app.post('/jobs/:job_id/_recover', (req, res) => {
        ...
        // FIXME: defer down to job service to get latest execution and restart of job
        _getLatestExecution(req.params.job_id)
    ...
    app.get('/jobs/:job_id/errors/', (req, res) => {
        ...
        jobsService.getExecutions(jobId)
            ...
            .then((exIds) => {
                ...
                // FIXME: there can be to many ex_id to query here, use latest instead
    ...
    // FIXME: have these call directly to cluster service since it has ex_id
    ...
    // FIXME: defer most of the logic to job service
    ...
    // TODO: this should probably be removed and used internally to jobs service
    ...
    // FIXME: call into cluster service for this functionality
