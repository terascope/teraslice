...
module.exports = function(context, app, cluster_service, jobs_service) {
    ...
    app.get('/jobs/:id', function(req, res) {
        ...
        logger.debug(`GET /jobs/:id endpoint has been called, job_id: ${job_id}`);
    ...
    app.put('/jobs/:id', function(req, res) {
        ...
        var job_spec = req.body;
        logger.debug(`PUT /jobs/:id endpoint has been called, job_id: ${job_id}, update changes: `, job_spec);
    ...
    app.post('/jobs/:id/_start', function(req, res) {
        var job_id = req.params.id;
        logger.debug(`GET /jobs/:id/_start endpoint has been called, job_id: ${job_id}`);
    ...
    app.get('/ex/:id', function(req, res) {
        ...
        logger.debug(`GET /ex/:id endpoint has been called, ex_id: ${ex_id}`);
    ...
    app.get('/ex/:id/slicer', function(req, res) {
        logger.debug(`GET /ex/:id/slicer endpoint has been called, ex_id: ${req.params.id}`);
