...
module.exports = function(context, app, cluster_service, jobs_service) {
    ...
    app.get('/jobs/:id/_slicer', function(req, res) {
        var job_id = req.params.id;
        slicerStats(job_id)
            .then(function(results) {
                res.status(200).json(results);
    ...
    app.get('/text/workers', function(req, res) {
    ...
    app.get('/text/nodes', function(req, res) {
    ...
    app.get('/text/jobs', function(req, res) {
    ...
    app.get('/text/slicers', function(req, res) {
        var defaults = [
            'job_id',
            'available_workers',
            'active_workers',
