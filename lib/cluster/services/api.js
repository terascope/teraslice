...
module.exports = function(context, app, cluster_service, jobs_service) {
    ...
    app.get('/jobs', function(req, res) {
        logger.trace(`GET /jobs endpoint has been called, from: ${req.query.from}, size: ${req.query.size}, sort: ${req.query.sort}`);
    ...
    app.get('/jobs/:id', function(req, res) {
        ...
        logger.trace(`GET /jobs/:id endpoint has been called, job_id: ${job_id}`);
    ...
    app.put('/jobs/:id', function(req, res) {
        ...
        var job_spec = req.body;
        logger.trace(`PUT /jobs/:id endpoint has been called, job_id: ${job_id}, update changes: `, job_spec);
    ...
    app.post('/jobs/:id/_start', function(req, res) {
        var job_id = req.params.id;
        logger.trace(`GET /jobs/:id/_start endpoint has been called, job_id: ${job_id}`);
    ...
    app.get('/ex', function(req, res) {
        logger.trace(`GET /jobs endpoint has been called, status: ${req.query.status}, from: ${req.query.from}, size: ${req.query.size}, sort: ${req.query.sort}`);
    ...
    app.get('/ex/:id', function(req, res) {
        ...
        logger.trace(`GET /ex/:id endpoint has been called, ex_id: ${ex_id}`);
    ...
    app.post('/ex/:id/_stop', function(req, res) {
        logger.debug(`POST /ex/:id/_stop endpoint has been called, ex_id: ${req.params.id}, removing any pending workers for the job`);
    ...
    app.post('/ex/:id/_pause', function(req, res) {
        logger.debug(`POST /ex/:id/_pause endpoint has been called, ex_id: ${req.params.id}`);
        _notifyExecutionContext(req.params.id, 'pause', res);
    });

    app.post('/ex/:id/_resume', function(req, res) {
        logger.debug(`POST /ex/:id/_resume endpoint has been called, ex_id: ${req.params.id}`);
        _notifyExecutionContext(req.params.id, 'resume', res);
    });

    app.post('/ex/:id/_recover', function(req, res) {
        var ex_id = req.params.id;
        logger.debug(`POST /ex/:id/_recover endpoint has been called, ex_id: ${req.params.id}`);
    ...
    app.post('/ex/:id/_workers', function(req, res) {
        logger.trace(`POST /ex/:id/_workers endpoint has been called, query:`,req.query);
        changeWorkers(req, res);
    });

    app.get('/ex/:id/slicer', function(req, res) {
        logger.trace(`GET /ex/:id/slicer endpoint has been called, ex_id: ${req.params.id}`);
