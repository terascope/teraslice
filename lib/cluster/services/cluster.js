...
module.exports = function(context, server) {
    ...
    messaging.register('node:online', 'node_id', function(data, node_id) {
        ...
        logger.debug(`node ${node_id} has state:`, data);
    ...
    messaging.register('slicer:job:finished', function(data) {
        ...
        logger.debug(`ex_id: ${data.ex_id} has finished, removing any from pending queue, message:`,data);
        ...
        return new Promise(function(resolve, reject) {
            ...
            event.on(msgData._msgID, function(nodeMasterData) {
                ...
                if (nodeMasterData.error) {
                    ...
                    logger.debug(`cluster_master completed message transation with node: ${node_id} for msg: ${msg} , msgData:`, msgData);
                    resolve(nodeMasterData)
                }
            });
            //send message
            logger.debug(`cluster_master communicating with node: ${node_id}, msg: ${msg}, msgData:`,msgData);
