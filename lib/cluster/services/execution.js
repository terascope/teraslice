...
module.exports = function module(context) {
    ...
    function searchExecutionContexts(query, from, _size, sort, fields) {
        let size = 10000;
        if (_size) size = _size;
        return exStore.search(query, from, size, sort, fields);
    }
    ...
    return Promise.all([require('../storage/execution')(context), require('../storage/analytics')(context)])
        .spread((ex, analytics) => {
