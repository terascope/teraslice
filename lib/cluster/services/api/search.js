...
module.exports = function (logger, req, defaultQuery, searchFn, fieldDefaults, _dateFieldDefaults) {
    ...
    const sort = req.query.sort || `${dateFieldDefaults}:desc`;
    const fields = fieldsQuery(req.query, fieldDefaults);
    const dateField = req.query.date_field || dateFieldDefaults;
    ...
    console.log('what is later query', query);
    ...
    console.log('the final body', JSON.stringify(body));
