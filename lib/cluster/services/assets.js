...
module.exports = function module(context) {
    ...
    const defaults = ['name', 'version', 'id', '_created', 'description'];
    let assetsStore;
    ...
    function assetsSearch(query, req, res) {
        ...
        return search(logger, req, query, assetsStore.search, defaults, '_created')
            .then((results) => {
                const data = _.get(results, 'hits.hits', []);
