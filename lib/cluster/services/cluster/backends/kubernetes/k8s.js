    ...
    */
    ...
    async deleteExecution(exId) {
        ...
        return Promise.all([
            ...
            // The execution_controller pod will shut down on it's own now that
            // it is a k8s Job.  We don't need to delete it here.  Though we may
            // change our minds.  I am going to leave this here a bit.  Delete
            // if it turns out we really don't want it.  We will have old Jobs
            // laying around as a consequence, and they will need to be manually
            // cleaned up.
            // FIXME: See https://github.com/terascope/teraslice/issues/772
