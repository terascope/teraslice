...
module.exports = function(context, index_name, record_type, id_field, bulk_size) {
    ...
    function search(query, from, size, sort) {
        ...
        return elaticsearch.search(esQuery)
    }
    ...
    function index(record) {
        ...
        return elaticsearch.index(query)
    }
    ...
    function indexWithId(record_id, record) {
        ...
        return elaticsearch.indexWithId(query);
    }
    ...
    function create(record) {
        ...
        return elaticsearch.create(query);
    }
    ...
    function update(record_id, update_spec) {
        ...
        return elaticsearch.update(query)
    }
    ...
    function remove(record_id) {
        ...
        return elaticsearch.remove(query)
    }
    ...
    return new Promise(function(resolve, reject) {
        ...
        elaticsearch = require('./../../../data_sources/elasticsearch')(client, logger, null);
        return _createIndex()
            .then(function(results) {
                return isAvailable();
            })
