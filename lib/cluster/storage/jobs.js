...
module.exports = function(context, jobType) {
    var logger = context.foundation.makeLogger({module: `${jobType}_storage`});
    var config = context.sysconfig.teraslice;
    var state_store;
    var jobs_index = jobType === 'job' ? `${config.name}__jobs`: `${config.name}__ex`;
    ...
    function searchExecutionContexts(status, from, size, sort) {
    ...
    var api = {
        ...
        search: search,
        getJobs: getJobs,
        searchExecutionContexts: searchExecutionContexts,
        create: create,
        update: update,
        remove: remove,
        shutdown: shutdown,
