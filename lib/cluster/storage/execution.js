...
module.exports = function (context) {
    ...
    function executionMetaData(hasErrors, stats, errMsg) {
        const metaData = { _has_errors: hasErrors || 'false', _slicer_stats: stats };
        if (errMsg) {
    ...
    function failureMetaData(errMsg, stats) {
        return executionMetaData(true, stats, errMsg);
    }
