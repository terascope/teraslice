...
module.exports = function module(context, messaging, exStore, stateStore, executionContext) {
    ...
    messaging.register({
        ...
        callback: (msg, workerId) => {
            ...
            // TODO move queue related fn's to be used internally to engine
            adjustQueueLength();
    ...
    function executionRecovery() {
        ...
        return new Promise((resolve, reject) => {
            if (recoverExecution) {
                ...
                Promise.resolve(recovery.recoverSlices())
    ...
    function slicerInitRetry(slicerError) {
        ...
        let times = 1;
        // TODO maxRetries does not exist
    ...
    function engineSetup() {
        ...
        recovery = require('./recovery')(context, messaging, executionAnalytics, exStore, stateStore, executionContext, enqueueSlice);
