...
module.exports = function module(context, executionContext) {
    const exId = process.env.ex_id;
    const jobId = process.env.job_id;
    const logger = context.apis.foundation.makeLogger({ module: 'slice_analytics', ex_id: exId, job_id: jobId });
    const operations = executionContext.config.operations;
