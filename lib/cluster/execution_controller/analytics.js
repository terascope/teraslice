...
module.exports = function executionAnalytics(context, messaging) {
    ...
    messaging.register({
        ...
        callback: (msg) => {
            ...
            messaging.respond(msg, {
                ...
                job_id: jobId,
                ex_id: exId,
                payload: { name, stats: slicerAnalytics }
            });
        }
    });
    ...
    // TODO beware this start immediately
    // push analytics to cluster master to support cluster level analytics
    const analyticsTimer = setInterval(pushAnalytics, context.sysconfig.teraslice.analytics_rate);

    function setValue(key, value) {
        slicerAnalytics[key] = value;
    }

    function increment(key) {
        slicerAnalytics[key] += 1;
    }

    function getAnalytics() {
        return _.cloneDeep(slicerAnalytics);
    }
