...
function recovery(context, messaging, executionAnalytics, exStore, stateStore, executionContext) {
    ...
    function initialize(skipStart = false) {
        ...
        if (skipStart) return Promise.resolve();

        return recoverSlices()
