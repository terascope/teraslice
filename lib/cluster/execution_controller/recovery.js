...
module.exports = function module(context, messaging, executionAnalytics, exStore, stateStore, executionContext, enqueueSlice) {
                ...
                _fetchIncompleteSlices(slicerID)
                    .then((slices) => {
                        if (slices.length === 0) {
                            ...
                            slices.forEach(slice => enqueueSlice(slice));
                            _waitForRecoveryBatchCompletion()
