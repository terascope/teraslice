...
module.exports = function (context) {
    ...
    function terminalShutdown(errEV) {
        ...
        messaging.send({ to: 'node_master', message: 'cluster:error:terminal', reply: false });
    }
    // TODO: some reason this is getting hit multiple times, should only be one

    messaging.register('worker:shutdown', () => {
        // Would there be sequencing required here?
        logger.error('cluster_master is shutting down');
