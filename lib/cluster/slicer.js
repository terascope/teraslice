...
module.exports = function module(contextConfig) {
    ...
    messaging.register('cluster:execution:pause', (msg) => {
    ...
    messaging.register('cluster:execution:resume', (msg) => {
    ...
    messaging.register('worker:slice:complete', 'worker_id', (msg, workerId) => {
        ...
        if (msg.error) {
            ...
            if (inRecoveryMode) {
                ...
                messaging.send({ to: 'cluster_master', message: 'slicer:recovery:failed', ex_id: exId });
        ...
        messaging.send({ to: 'worker', address: workerId, message: 'slicer:slice:recorded', payload: null });
