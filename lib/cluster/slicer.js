...
module.exports = function(context) {
                ...
                if (workerQueue.size() >= messaging.getClientCounts() && slicerQueue.size() === 0 && !inRecoveryMode) {
                    ...
                    checkJobState(job.jobConfig)
                        ...
                        .catch(function(err) {
                            ...
                            logger.error(`execution ${ex_id} was not able run the job complete sequence and update its status, slicer will soon exit, error: ${errMsg}`);
    ...
    function allocateSlice(slice_request, slicer_id, slicer_order) {
       ...
       // ex_id:a82b550f-ecd6-436d-b071-07febbaa1c8d AND (state:error OR state:start)
