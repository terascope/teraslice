...
module.exports = function(context) {
    ...
    io.on('connection', function(socket) {
        ...
        socket.on('worker:slice_complete', function(msg) {
            slicerAnalytics.slices_processed += 1;
            ...
            if (msg.error) {
                slicerAnalytics.failed_slices += 1;
            ...
            return reader.newSlicer(context, job, retryData, slicerAnalytics)
                .then(function(slicers) {
                    ...
                    engineFn = function engineFn() {
                        ...
                        slicerAnalytics.slices_enqueued = slicerQueue.size();
                    ...
                    event.on('slicer:job_finished', function() {
                        ...
                        if (slicerDone === totalSlicers) {
                            var isDone = setInterval(function() {
                                ...
                                allSlicersDone = true;
                                slicerAnalytics.all_data_sliced = true;
    ...
    process.on('message', function(msg) {
        ...
        if (msg.message === 'cluster_service:slicer analytics') {
            process.send({message: 'slicer:slicer_analytics', data: JSON.stringify(analyticsData)})
        }
    });
