...
module.exports = function(context) {
    ...
    var logger = context.foundation.makeLogger('worker', ID, {ex_id: job.jobConfig.ex_id, assingment: 'worker', worker_id: ID});
    ...
    function isReady(res, slice, msg, specData) {
        ...
        if (res && res.errors) {
            logger.error('should never ever get here in worker')
