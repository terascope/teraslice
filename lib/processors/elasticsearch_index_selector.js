...
function post_validation(job, sysconfig) {
    ...
    // we don't require the full_response option on the
    // elasticsearch_data_generator, but other readers require it, it is assumed
    // that the user has manually added IDs in the generated data case.
    if (opConfig.preserve_id && (job.operations[0]._op != 'elasticsearch_data_generator')) {
