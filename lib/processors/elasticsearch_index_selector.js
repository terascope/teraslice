...
function newProcessor(context, opConfig, jobConfig) {
    ...
    if (opConfig.timeseries && !opConfig.index_prefix) {
        throw "timeseries requires an index_prefix"
    }

    // date_field is required if timeseries is specified. If not present we'll use a default.
    if (opConfig.timeseries && !opConfig.date_field) {
        opConfig.date_field = '@timestamp';
    }
