...
function distributeJob(context, clusterState, io, job, res, jobName, jobRequest) {
...
//TODO this is duplicate
        ...
        setTimeout(function() {
            console.log('the set timeout is getting called');
            distributeJob(context, clusterState, io, job, res, jobName, jobRequest)
        }, 5000)
