...
// TODO fix autodates
// TODO elasticError fix, if it needs to be a module
...
module.exports = function(client, logger, opConfig) {
    ...
    function get(query) {
        ...
        return new Promise(function(resolve, reject) {
            var errHandler = _errorHandler(retryTimer, getRecord, reject, logger);
    ...
    function index(query) {
        ...
        return new Promise(function(resolve, reject) {
            var errHandler = _errorHandler(retryTimer, indexRecord, reject, logger);
    ...
    function indexWithId(query) {
        ...
        return new Promise(function(resolve, reject) {
            var errHandler = _errorHandler(retryTimer, indexRecordID, reject, logger);
    ...
    function create(query) {
        ...
        return new Promise(function(resolve, reject) {
            var errHandler = _errorHandler(retryTimer, createRecord, reject, logger);
    ...
    function update(query) {
        ...
        return new Promise(function(resolve, reject) {
            var errHandler = _errorHandler(retryTimer, updateRecord, reject, logger);
    ...
    function remove(query) {
        ...
        return new Promise(function(resolve, reject) {
            var errHandler = _errorHandler(retryTimer, removeRecord, reject, logger);
    ...
    function _errorHandler(retryTimer, fn, reject, logger) {
        return function(err) {
...
// slicer get dates
    ...
    function autoDates(query, givenDate, order, dateFormat) {
        return client.search(query)
            .then(function(data) {
                ...
                if (order === 'start') {
                    return _parseDate(data.hits.hits[0]._source[opConfig.date_field_name])
                }
                else {
...
// date slicer
    ...
    function index_exists(query) {
        ...
        return new Promise(function(resolve, reject) {
            var errHandler = _errorHandler(retryTimer, exists, reject, logger);
    ...
    function index_create(query) {
        ...
        return new Promise(function(resolve, reject) {
            var errHandler = _errorHandler(retryTimer, indexCreate, reject, logger);
    ...
    function index_refresh(query) {
        ...
        return new Promise(function(resolve, reject) {
            var errHandler = _errorHandler(retryTimer, indexRefresh, reject, logger);
    ...
    function index_recovery(query) {
        ...
        return new Promise(function(resolve, reject) {
            var errHandler = _errorHandler(retryTimer, indexRecovery, reject, logger);
