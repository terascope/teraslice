...
module.exports = function(context) {
    ...
    var distConfig = context.sysconfig.teraslice.distributed;
    ...
    var scheduler = code.scheduler(nextSlice, start, workerQueue, code.jobConfig, sendMessage, analyticsData, distConfig, terminateWorker);
    ...
    io.listen(distConfig.slicer_port)
};
