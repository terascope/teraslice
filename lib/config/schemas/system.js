...
var schema = {
    ops_directory: {
        doc: 'directory to look for more readers, processors and senders',
        default: __dirname + '/lib',
        format: 'optional_String'
    },
    shutdown_timeout: {
        doc: 'time (in seconds), to allow workers and slicers to finish operations before forcefully shutting down',
        default: 60,
        format: function(val) {
            if (isNaN(val)) {
    ...
    reporter: {
        doc: 'set for specialized custom reporting of stats',
        default: ''
    },
    hostname: {
