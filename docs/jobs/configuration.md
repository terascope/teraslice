...
| `log_level`            | log level that will be used for all loggers associated with this job. Overwrites log_level from `terafoundation`.                                                                                | `'trace' \| 'debug' \| 'info' \| 'warn' \| 'error' \| 'fatal'` | optional, defaults to `info`                                                                                                                                                                                                |
