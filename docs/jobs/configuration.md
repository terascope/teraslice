...
| `worker_version` | Which version of the worker runOnce() and shutdown() functions to use. Overrides the property with same name in the teraslice config.                                                                               | `v1` &#124; `v2` | optional                                                                                                                                                                                        |
