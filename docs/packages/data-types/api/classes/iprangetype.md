...
* [config](iprangetype.md#config)
* [field](iprangetype.md#field)
* [version](iprangetype.md#version)

### Methods

* [_formatGQLTypeName](iprangetype.md#_formatgqltypename)
...
\+ **new IpRangeType**(`field`: string, `config`: [FieldTypeConfig](../overview.md#fieldtypeconfig), `version`: number): *[IpRangeType](iprangetype.md)*
...
*Defined in [data-types/src/types/v1/ip-range.ts:6](https://github.com/terascope/teraslice/blob/653cf7530/packages/data-types/src/types/v1/ip-range.ts#L6)*
...
*Defined in [data-types/src/types/v1/ip-range.ts:10](https://github.com/terascope/teraslice/blob/653cf7530/packages/data-types/src/types/v1/ip-range.ts#L10)*
...
*Defined in [data-types/src/types/v1/ip-range.ts:14](https://github.com/terascope/teraslice/blob/653cf7530/packages/data-types/src/types/v1/ip-range.ts#L14)*
