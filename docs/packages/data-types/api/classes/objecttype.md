...
* [config](objecttype.md#config)
* [field](objecttype.md#field)
* [version](objecttype.md#version)

### Methods

* [_formatGQLTypeName](objecttype.md#_formatgqltypename)
...
\+ **new ObjectType**(`field`: string, `config`: [FieldTypeConfig](../overview.md#fieldtypeconfig), `version`: number): *[ObjectType](objecttype.md)*
...
*Defined in [types/v1/object.ts:5](https://github.com/terascope/teraslice/blob/f95bb5556/packages/data-types/src/types/v1/object.ts#L5)*
...
*Defined in [types/v1/object.ts:14](https://github.com/terascope/teraslice/blob/f95bb5556/packages/data-types/src/types/v1/object.ts#L14)*
...
*Defined in [types/v1/object.ts:18](https://github.com/terascope/teraslice/blob/f95bb5556/packages/data-types/src/types/v1/object.ts#L18)*
