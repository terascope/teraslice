...
* [version](keywordtokens.md#version)
...
\+ **new KeywordTokens**(`field`: string, `config`: [FieldTypeConfig](../overview.md#fieldtypeconfig), `version`: number): *[KeywordTokens](keywordtokens.md)*
...
*Defined in [types/v1/keyword-tokens.ts:5](https://github.com/terascope/teraslice/blob/b843209f9/packages/data-types/src/types/v1/keyword-tokens.ts#L5)*
...
*Defined in [types/v1/keyword-tokens.ts:21](https://github.com/terascope/teraslice/blob/b843209f9/packages/data-types/src/types/v1/keyword-tokens.ts#L21)*
...
*Defined in [types/v1/keyword-tokens.ts:25](https://github.com/terascope/teraslice/blob/b843209f9/packages/data-types/src/types/v1/keyword-tokens.ts#L25)*
