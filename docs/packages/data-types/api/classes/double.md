...
* [config](double.md#config)
* [field](double.md#field)
* [version](double.md#version)

### Methods

* [_formatGQLTypeName](double.md#_formatgqltypename)
...
\+ **new Double**(`field`: string, `config`: [FieldTypeConfig](../overview.md#fieldtypeconfig), `version`: number): *[Double](double.md)*
...
*Defined in [data-types/src/types/v1/double.ts:6](https://github.com/terascope/teraslice/blob/653cf7530/packages/data-types/src/types/v1/double.ts#L6)*
...
*Defined in [data-types/src/types/v1/double.ts:10](https://github.com/terascope/teraslice/blob/653cf7530/packages/data-types/src/types/v1/double.ts#L10)*
...
*Defined in [data-types/src/types/v1/double.ts:14](https://github.com/terascope/teraslice/blob/653cf7530/packages/data-types/src/types/v1/double.ts#L14)*
