...
* [config](datetype.md#config)
* [field](datetype.md#field)
* [version](datetype.md#version)

### Methods

* [_formatGQLTypeName](datetype.md#_formatgqltypename)
...
\+ **new DateType**(`field`: string, `config`: [FieldTypeConfig](../overview.md#fieldtypeconfig), `version`: number): *[DateType](datetype.md)*
...
*Defined in [data-types/src/types/v1/date.ts:6](https://github.com/terascope/teraslice/blob/653cf7530/packages/data-types/src/types/v1/date.ts#L6)*
...
*Defined in [data-types/src/types/v1/date.ts:10](https://github.com/terascope/teraslice/blob/653cf7530/packages/data-types/src/types/v1/date.ts#L10)*
...
*Defined in [data-types/src/types/v1/date.ts:14](https://github.com/terascope/teraslice/blob/653cf7530/packages/data-types/src/types/v1/date.ts#L14)*
