...
*Defined in [packages/job-components/src/builtin/noop/processor.ts:5](https://github.com/terascope/teraslice/blob/653cf7530/packages/job-components/src/builtin/noop/processor.ts#L5)*
