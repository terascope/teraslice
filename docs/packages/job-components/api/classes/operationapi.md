...
*Defined in [operations/operation-api.ts:16](https://github.com/terascope/teraslice/blob/6aab1cd2/packages/job-components/src/operations/operation-api.ts#L16)*
