...
*Defined in [operations/each-processor.ts:15](https://github.com/terascope/teraslice/blob/6e018493/packages/job-components/src/operations/each-processor.ts#L15)*
...
*Defined in [operations/each-processor.ts:22](https://github.com/terascope/teraslice/blob/6e018493/packages/job-components/src/operations/each-processor.ts#L22)*
