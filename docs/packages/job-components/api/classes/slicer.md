...
*Defined in [packages/job-components/src/operations/slicer.ts:22](https://github.com/terascope/teraslice/blob/78714a985/packages/job-components/src/operations/slicer.ts#L22)*
