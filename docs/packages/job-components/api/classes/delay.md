...
▸ **onBatch**(`data`: DataEntity[]): *Promise‹DataEntity‹object, object›[]›*

*Overrides [BatchProcessor](batchprocessor.md).[onBatch](batchprocessor.md#abstract-onbatch)*

*Defined in [builtin/delay/processor.ts:6](https://github.com/terascope/teraslice/blob/0ae31df4/packages/job-components/src/builtin/delay/processor.ts#L6)*
