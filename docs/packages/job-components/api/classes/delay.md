...
*Defined in [packages/job-components/src/builtin/delay/processor.ts:6](https://github.com/terascope/teraslice/blob/653cf7530/packages/job-components/src/builtin/delay/processor.ts#L6)*
