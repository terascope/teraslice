...
▸ **onBatch**(`data`: DataEntity[]): *Promise‹DataEntity‹object, __type›[]›*

*Overrides [BatchProcessor](batchprocessor.md).[onBatch](batchprocessor.md#abstract-onbatch)*

*Defined in [packages/job-components/src/builtin/delay/processor.ts:6](https://github.com/terascope/teraslice/blob/78714a985/packages/job-components/src/builtin/delay/processor.ts#L6)*
