...
*Defined in [packages/job-components/src/operations/batch-processor.ts:13](https://github.com/terascope/teraslice/blob/f95bb5556/packages/job-components/src/operations/batch-processor.ts#L13)*
