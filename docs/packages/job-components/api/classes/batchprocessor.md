...
*Defined in [packages/job-components/src/operations/batch-processor.ts:13](https://github.com/terascope/teraslice/blob/b843209f9/packages/job-components/src/operations/batch-processor.ts#L13)*
