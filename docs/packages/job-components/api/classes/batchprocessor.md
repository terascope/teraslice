...
*Defined in [operations/batch-processor.ts:13](https://github.com/terascope/teraslice/blob/0ae31df4/packages/job-components/src/operations/batch-processor.ts#L13)*
