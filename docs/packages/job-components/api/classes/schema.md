...
*Defined in [packages/job-components/src/builtin/collect/schema.ts:5](https://github.com/terascope/teraslice/blob/653cf7530/packages/job-components/src/builtin/collect/schema.ts#L5)*
