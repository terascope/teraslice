---
title: Job Components Operations Each Processor Eachprocessor
sidebar_label: Operations Each Processor Eachprocessor
---

> Operations Each Processor Eachprocessor for @terascope/job-components

[Globals](../overview.md) / ["operations/each-processor"](../modules/_operations_each_processor_.md) / [EachProcessor](_operations_each_processor_.eachprocessor.md) /
...
* [constructor](_operations_each_processor_.eachprocessor.md#constructor)

#### Properties

* [context](_operations_each_processor_.eachprocessor.md#context)
* [deadLetterAction](_operations_each_processor_.eachprocessor.md#deadletteraction)
* [events](_operations_each_processor_.eachprocessor.md#events)
* [executionConfig](_operations_each_processor_.eachprocessor.md#executionconfig)
* [logger](_operations_each_processor_.eachprocessor.md#logger)
* [opConfig](_operations_each_processor_.eachprocessor.md#opconfig)

#### Methods

* [createAPI](_operations_each_processor_.eachprocessor.md#createapi)
* [forEach](_operations_each_processor_.eachprocessor.md#abstract-foreach)
* [getAPI](_operations_each_processor_.eachprocessor.md#getapi)
* [handle](_operations_each_processor_.eachprocessor.md#handle)
* [initialize](_operations_each_processor_.eachprocessor.md#initialize)
* [rejectRecord](_operations_each_processor_.eachprocessor.md#rejectrecord)
* [shutdown](_operations_each_processor_.eachprocessor.md#shutdown)
* [tryRecord](_operations_each_processor_.eachprocessor.md#tryrecord)

## Constructors

###  constructor

\+ **new EachProcessor**(`context`: *[WorkerContext](../interfaces/_interfaces_context_.workercontext.md)*, `opConfig`: *[OpConfig](../interfaces/_interfaces_jobs_.opconfig.md) & `T`*, `executionConfig`: *[ExecutionConfig](../interfaces/_interfaces_jobs_.executionconfig.md)*): *[EachProcessor](_operations_each_processor_.eachprocessor.md)*
...
**Returns:** *[EachProcessor](_operations_each_processor_.eachprocessor.md)*
...
*Defined in [operations/each-processor.ts:15](https://github.com/terascope/teraslice/tree/0c8b1cfadd6cd255811e506264906c5373f2ebea/packages/job-components/operations/each-processor.ts#L15)*
...
*Defined in [operations/each-processor.ts:22](https://github.com/terascope/teraslice/tree/0c8b1cfadd6cd255811e506264906c5373f2ebea/packages/job-components/operations/each-processor.ts#L22)*
