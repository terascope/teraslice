...
export default [
    ['count:(>=10 AND <=20 AND >=100)',
        'a field group expression with ranges',
        {
    ...
    ['count:(>=10 OR <=20 OR >=100)',
        'a chained OR field group expression with ranges',
        {
            type: NodeType.FieldGroup,
            field: 'count',
            flow: [
    ...
    ['id: (AqMvPMCS76u0 OR 497qIZuha9_u OR Oc2DG0O2gbcY)',
        'chained ORs with restricted strings',
        {
            type: NodeType.FieldGroup,
            field: 'id',
            flow: [
    ...
    ['count:($foo $bar)',
        'implicit OR grouping with variables',
        {
            type: NodeType.FieldGroup,
            field: 'count',
            flow: [
    ...
    ['foo:(bar baz)',
        'multi-value field group with no quotes',
        {
            type: NodeType.FieldGroup,
            field: 'foo',
            flow: [
