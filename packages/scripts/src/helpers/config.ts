...
export const KAFKA_SSL_KEYSTORE_LOCATION = process.env.KAFKA_SSL_KEYSTORE_LOCATION || `${KAFKA_SECRETS_DIR}/kafka.keystore.jks`;
export const KAFKA_SSL_KEYSTORE_PASSWORD = process.env.KAFKA_SSL_KEYSTORE_PASSWORD || 'test123';
export const KAFKA_SSL_TRUSTSTORE_LOCATION = process.env.KAFKA_SSL_TRUSTSTORE_LOCATION || `${KAFKA_SECRETS_DIR}/kafka.truststore.jks`;
export const KAFKA_SSL_TRUSTSTORE_PASSWORD = process.env.KAFKA_SSL_TRUSTSTORE_PASSWORD || `test123`;
