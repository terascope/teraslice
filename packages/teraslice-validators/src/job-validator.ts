...
import { commonSchema } from './job-schemas';
import { validateJobConfig } from './config-validators';

interface JobValidatorOptions {
    skipRegister?: boolean;
}

export class JobValidator {
    private readonly context: Context;
    private readonly options: JobValidatorOptions;

    constructor(context: Context, options: JobValidatorOptions = {}) {
        this.context = context;
        this.options = options;
    }

}
// export function validateJob(_context, { skipRegister } = {}) {
