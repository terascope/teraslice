...
import {
    castArray, get, getTypeOf, has,
    isInteger, isString, TSError, uniq,
    type Logger
} from '@terascope/utils';
import type { Client } from 'elasticsearch-store';
import type { IndexConfig, IndexSchema, DataSchema } from '../interfaces.js';
import { throwValidationError, getErrorMessages } from 'elasticsearch-store';
