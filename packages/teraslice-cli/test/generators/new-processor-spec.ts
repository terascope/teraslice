...
it.todo('processor generator with no new flag')

// describe('processor generator with no new flag', () => {
//     const exampleAssetBasePath = path.join(dirPath, '..', 'fixtures', 'generate-new-processor');
...
//     const helpersPath = path.join(dirPath, '..', '..', 'src', 'generators', 'new-processor');
//     console.dir({ exampleAssetBasePath, helpersPath })
//     beforeAll(async () => {
//         return helpers.run(helpersPath)
...
//     afterAll(() => {
//         fs.removeSync(path.join(dirPath, '..', 'fixtures', 'generate-new-processor', 'example-asset', 'asset', 'example'));
//         fs.removeSync(path.join(dirPath, '..', 'fixtures', 'generate-new-processor', 'example-asset', 'spec', 'example-spec.js'));
//     });

//     it('should generate index.js, processor.js, and schema.js in the asset dir', () => {
//         const firstPath =  path.join(processPath, 'example', 'processor.js');
//         console.log('here',firstPath)

//         try {
//             assert.file(firstPath)
//         } catch(err) {
...
//     const testAssetBasePath = path.join(dirPath, '..', 'fixtures', 'generate-new-processor');
//     const processPath = path.join(testAssetBasePath, 'test-asset', 'asset');
//     const testPath = path.join(testAssetBasePath, 'test-asset', 'test');
//     const helpersPath = path.join(dirPath, '..', '..', 'src/index.js', 'generators', 'new-processor');
...
//     afterAll(() => {
//         fs.removeSync(path.join(dirPath, '..', 'fixtures', 'generate-new-processor', 'test-asset', 'asset', 'good_processor'));
//         fs.removeSync(path.join(dirPath, '..', 'fixtures', 'generate-new-processor', 'test-asset', 'test', 'good_processor-spec.js'));
//     });
