...
describe('teraslice-util', () => {
    ...
    test('should parse response into an array', () => {
        const cliConfig = {
            config_dir: path.join(tmpDir, 'config_dir/'),
        };
        testTerasliceUtil = new TerasliceUtil(cliConfig);
        ...
        const result = testTerasliceUtil.parseResponse(response, header);
    ...
    test('should parse state response into an array', () => {
        const cliConfig = {
            config_dir: path.join(tmpDir, 'config_dir/'),
        };
        testTerasliceUtil = new TerasliceUtil(cliConfig);
        ...
        const id = '0000004';
        const result = testTerasliceUtil.parseStateResponse(response, header, id);
        console.log(result);
    ...
    test('should parse state response into an array when id is not defined', () => {
        const cliConfig = {
            config_dir: path.join(tmpDir, 'config_dir/'),
        };
        testTerasliceUtil = new TerasliceUtil(cliConfig);
        ...
        const result = testTerasliceUtil.parseStateResponse(response, header);
        expect(result[0][0]).toEqual('worker');
