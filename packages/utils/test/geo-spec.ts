...
describe('geo utils', () => {
    ...
    describe('->toGeoJSON', () => {
        ...
        const testCases: Case[] = [
            ...
            [
                'converts an Elasticsearch multi-line-string to a GeoJson multi-line-string',
                {
                    type: ESGeoShapeType.MultiLineString,
                    coordinates: [
                        [
                            [67.66, 39.90], [67.65, 39.90], [67.65, 39.90], [67.65, 39.90]
                        ],
                        [
                            [67.76, 39.80], [67.75, 39.80], [67.75, 39.80], [67.75, 39.80]
                        ]
                    ]
                },
                {
