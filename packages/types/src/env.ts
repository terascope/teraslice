...
export interface TestEnv {
    ...
    TERASLICE_DOCKER_VOLUME_PATHS?: string;
...
export type ScriptsTestEnv = RequireKeys<
    ...
    | 'CEPH_ACCESS_KEY' | 'CEPH_DASHBOARD_PORT' | 'CEPH_DOCKER_IMAGE'
    | 'CEPH_NAMESPACE' | 'CEPH_STORE_NAME' | 'CEPH_OPERATOR_DOCKER_IMAGE'
    ...
    | 'ENCRYPT_CEPH' | 'ENCRYPT_KAFKA' | 'ENCRYPT_MINIO' | 'ENCRYPT_OPENSEARCH' | 'ENCRYPT_VALKEY'
    ...
    | 'TERASLICE_DOCKER_VOLUME_PATHS' | 'TERASLICE_HOST' | 'TERASLICE_IMAGE' | 'TERASLICE_PORT' | 'TERASLICE_VERSION'
