...
export type E2ETestEnv = RequireKeys<
    ...
    | 'TERASLICE_CLUSTER_NAME' | 'TERASLICE_PORT' | 'TEST_INDEX_PREFIX' | 'TEST_PLATFORM'
>;
...
export type ScriptsTestEnv = RequireKeys<
    ...
    | 'SKIP_GIT_COMMANDS' | 'SKIP_IMAGE_DELETION' | 'TERASLICE_CLUSTER_NAME' | 'TERASLICE_IMAGE'
    | 'TERASLICE_PORT' | 'TEST_NAMESPACE' | 'USE_EXISTING_SERVICES' | 'UTILITY_SVC_DOCKER_IMAGE'
