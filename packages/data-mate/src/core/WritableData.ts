...
import { default as dataStructures } from 'mnemonist';

const { SparseMap } = dataStructures
...
export class WritableData<T> {
    ...
    */
    private readonly _values:  dataStructures.SparseMap<T>;
    ...
    */
    ...
    rawValues(): dataStructures.SparseMap<T> {
        return this._values;
    }
}
